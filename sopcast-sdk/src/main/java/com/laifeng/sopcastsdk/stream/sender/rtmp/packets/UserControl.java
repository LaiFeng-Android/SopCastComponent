...
public class UserControl extends Chunk {
    ...
    public UserControl(ChunkHeader header) {
        super(header);
    }

    public UserControl() {
        super(new ChunkHeader(ChunkType.TYPE_0_FULL, SessionInfo.RTMP_CONTROL_CHANNEL, MessageType.USER_CONTROL_MESSAGE));
    }

    /** Convenience construtor that creates a "pong" message for the specified ping */
    public UserControl(UserControl replyToPing) {
